...
INSERT INTO "new_prompts" ("approvedAt", "approvedBy", "authorId", "categoryId", "content", "createdAt", "description", "downloads", "id", "image", "isFeatured", "price", "rating", "reviewCount", "status", "tags", "title", "updatedAt", "views") SELECT "approvedAt", "approvedBy", "authorId", "categoryId", "content", "createdAt", "description", "downloads", "id", "image", "isFeatured", "price", "rating", "reviewCount", "status", "tags", "title", "updatedAt", "views" FROM "prompts";
DROP TABLE "prompts";
